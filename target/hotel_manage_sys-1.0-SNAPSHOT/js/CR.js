...
$(function () {
            ...
            success: function (roomList) {
                ...
                $(roomList).each(function (i, room) {
                        ...
                        if (Number(status) === Number("1")) {
                            ...
                            td.eq(3).html(
                                '<span><a class="div-agree" href="#" id="agree' + i + '"> <span class="agree"></span></a>' +
    ...
    fn1 = function (room) {
        ...
        fn5("removeAccept", roomNumber, price)
    }
    ...
    fn2 = function (room) {
        var roomNumber = $(room).attr("roomNumber")
        var price = $(room).attr("price")
        fn5("removeRefuse", roomNumber, price)
    }
